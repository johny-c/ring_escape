...
/**
 * Interface that contains all constants that are used 
...
public interface AppConstants {
	...
	// distances
	static final double REACH_DISTANCE_IN_KM = 1.2;
	...
	static final int GAME_DURATION = 2 * 60 * 1000 + COUNTDOWN_TIME; 
	// 2 minutes
	static final int ESCAPE_TIME = 10 * 1000;
